...
export default function NeosisChat() {
  ...
  if(!currentUser) return <div className="flex h-screen items-center justify-center font-semibold text-blue-600 dark:bg-gray-900 dark:text-blue-400 transition-colors duration-300">Loading Neosis...</div>;
          ...
          {!activeChat ? (
            ...
            <>
              ...
              <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 flex items-center gap-4 shadow-sm z-10 transition-colors duration-300">
                ...
                <div>
                  <div className="font-bold text-gray-800 dark:text-gray-100">{activeChat}</div>
